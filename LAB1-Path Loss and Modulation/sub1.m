...
function [bpsk_throughput_empirical, qpsk_throughput_empirical, qam16_throughput_empirical, qam64_throughput_empirical] = sub1(param1)
    ...
    theoretical_SNR = Pt_watts / N0_watts;
